    ...
    <!-- Collect the nav links, forms, and other content for toggling -->
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
              <li><a href="${pageContext.request.contextPath }/jsp/homeManage/main.jsp">首页</a></li>
   	        ...
   	        <div class="panel panel-primary">
                ...
                <div class="col-lg-12" >
					...
					<form method="post" name="addMileStone" action="${pageContext.request.contextPath}/servlet/StageServlet">
						...
						<div id="first_right">
						<input type="text" name="StageName" size="40px;">
						</div>
						<div class="clear"></div>
						</div>
                    ...
                    <div id="responsible_per" class="block">
						<div style="text-align: right">
							...
							<button type="" class="btn btn-primary" ><a href="PlanManagement_Newed.jsp" style="color:white;">结束新建</a></button>
						</div>
						<div class="clear"></div>
						</div>
                    </form>
