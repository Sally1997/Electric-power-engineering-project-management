    	...
    	<div class="row">
    		...
    		<div class="col-lg-8" style="float:none; margin: 20px auto">
   	        <div class="panel panel-primary" style="margin: 20px auto">
    	        <div class="panel-heading">新建任务内容</div><!-- 这里是这个项目的名字 -->
   	        ...
   	        <div class="panel panel-primary">
                ...
                <div class="col-lg-12" >
					<form action="" method="post" name="form1">
						...
						<div class="hehe_left">
						<span class="text">任务名称:</span><span style="color:red">&nbsp;*</span>
						</div>
...
function addGoal()
{
	//alert(bigsn); 通过点击指标详情，获取到你正在查看的任务名称
