	...
	<div>
		...
		<table class="table table-striped table-condensed" style="font-size: 15px">
		    ...
		    <tr>
			    ...
			    <td align="left" id="pro1_3"></td>
			    <td align="left" id="pro1_4"></td>
			    <td align="left" id="pro1_5"></td>
			    <td align="left" id="pro1_6"></td>
		    </tr>
		    
		    <tr>
			    <td align="left" id="pro2_1"></td>
			    <td align="left">
			    	<div class="dropdown"><span id="pro2_2"></span>
  						<span class="glyphicon glyphicon-paperclip" style="cursor: pointer;float:right;" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"></span>
  						<ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
    						<li><a href="/RealProject/web/servlet/staffListServlet?pno=10001">人员管理</a></li>
    						<li><a href="/RealProject/jsp/projectManage/PlanManagement_NewMilestone.jsp">计划管理</a></li>
			    ...
			    <td align="left" id="pro2_3"></td>
			    <td align="left" id="pro2_4"></td>
			    <td align="left" id="pro2_5"></td>
			    <td align="left" id="pro2_6"></td>
		    </tr>
		    
		    <tr>
			    <td align="left" id="pro3_1"></td>
			    <td align="left">
			    	<div class="dropdown"><span id="pro3_2"></span>
  						<span class="glyphicon glyphicon-paperclip" style="cursor: pointer;float:right;" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"></span>
  						<ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
    						<li><a href="/RealProject/web/servlet/staffListServlet?pno=10001">人员管理</a></li>
    						<li><a href="/RealProject/jsp/projectManage/PlanManagement_NewMilestone.jsp">计划管理</a></li>
		    ...
		    <tr>
			    <td align="left" id="pro4_1"></td>
			    <td align="left">
			    	<div class="dropdown"><span id="pro4_2"></span>
  						<span class="glyphicon glyphicon-paperclip" style="cursor: pointer;float:right;" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"></span>
  						<ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
    						<li><a href="/RealProject/web/servlet/staffListServlet?pno=10001">人员管理</a></li>
    						<li><a href="/RealProject/jsp/projectManage/PlanManagement_NewMilestone.jsp">计划管理</a></li>
			    ...
			    <td align="left" id="pro4_3"></td>
			    <td align="left" id="pro4_4"></td>
			    <td align="left" id="pro4_5"></td>
			    <td align="left" id="pro4_6"></td>
		    </tr>
...
<script type="text/javascript">
	...
	window.onload = function(){
		...
		//创建连接
	aja.open("get", "/RealProject/servlet/ShowProjectServlet");
	//发送请求
	aja.send(null);
	}
