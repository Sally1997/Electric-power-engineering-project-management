...
public class TaskMesgDaoImpl implements TaskMesgDao{
	...
	public List<TaskMesg> findallTaskMesg(String me) throws SQLException{
		...
		return qr.query("select e.mno,d.pno,d.pname,d.StageNo,d.SName,e.taskno,e.TaskName,e.mdate,e.hasread,e.mtype "
				+ "from(select a.pno,a.pname,b.StageNo,b.SName from project a,psplan b where a.pno=b.PNo) d,"
				+ "(select b.mno,a.taskno,a.TaskName,a.stageno,b.mdate,b.hasread,b.mtype from stagetasks a,inform b"
				+ " where a.TaskNo=b.busNo and b.dstPNo=? and b.mtype in('T3','T2') and b.hasread='0') e"
	...
	public List<TaskMesg> findallStageMesg(String me) throws SQLException{
		QueryRunner qr = new QueryRunner(C3P0Util.getDataSource());
		return qr.query("select n.mno,m.pno,m.pname,m.StageNo,m.SName,n.mdate,n.hasread,n.mtype from"+
		"(select a.pno,a.pname,b.StageNo,b.SName from project a,psplan b where a.pno=b.PNo) m,"+
		"(select b.mno,a.PNo,a.SName,a.StageNo,b.mdate,b.hasread,b.mtype from psplan a,inform b where a.StageNo=b.busNo and b.mtype in('T1','T0') and b.dstPNo=? and b.hasread='0') n"+
