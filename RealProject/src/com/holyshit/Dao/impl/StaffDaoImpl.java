...
public class StaffDaoImpl implements StaffDao {
	public List<Staff> findallstageleader(String pno) throws SQLException{
		QueryRunner qr=new QueryRunner(C3P0Util.getDataSource());
		return qr.query("select a.staffno from staff a,psplan b where a.StaffNo=b.CharPNo and b.PNo=?", pno, new BeanListHandler<Staff>(Staff.class));
	}
	
	public List<Staff> findalltaskleader(String pno) throws SQLException{
		QueryRunner qr=new QueryRunner(C3P0Util.getDataSource());
