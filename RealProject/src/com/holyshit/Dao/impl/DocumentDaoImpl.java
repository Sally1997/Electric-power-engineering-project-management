...
public class DocumentDaoImpl implements DocumentDao{
	public List<Document> findallneededauditfile(String me) throws SQLException{
		QueryRunner qr = new QueryRunner(C3P0Util.getDataSource());
		return qr.query("select * from document where dtype!='1' and auditres='0' and uloadpno!=? order by uploadtime desc", me, new BeanListHandler<Document>(Document.class));
	}
